...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let label1 = UILabel()
        //removes auto contraints added by apple
        ...
        for label in viewsDictonary.keys {
            //H: means horizontal layout, pipe symbol means edge of the view
            //whole thing means horizontally you want the label to go to the edge of the view
